...
INSERT INTO `cls` VALUES (1,'Lily',13,'w',96),(2,'Tom',14,'m',85),(3,'Ali',22,'m',100),(5,'Niu',15,'w',60),(6,'Chen',21,'w',100);
...
INSERT INTO `hobby` VALUES (1,'Lily',13,'w','sing,dance');
...
INSERT INTO `interest` VALUES (1,'Ali','sing,dance',16800.00,NULL,'无敌少有');
...
INSERT INTO `marathon` VALUES (1,'曹操','1990-02-05','2020-02-05 12:12:12','02:02:02'),(2,'关羽','1991-02-06','2020-02-05 12:13:14','02:02:02'),(3,'刘备','1992-02-07','2020-02-05 12:05:14','02:02:02');
...
LOCK TABLES `pyp` WRITE;
/*!40000 ALTER TABLE `pyp` DISABLE KEYS */;
/*!40000 ALTER TABLE `pyp` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `user_pyp`
--

DROP TABLE IF EXISTS `user_pyp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_pyp` (
  `id` int(11) NOT NULL,
  `uid` int(11) DEFAULT NULL,
  `pid` int(11) DEFAULT NULL,
  `lk` bit(1) DEFAULT NULL,
  `comment` text,
  PRIMARY KEY (`id`),
  KEY `u_fk2` (`uid`),
  KEY `p_fk` (`pid`),
  CONSTRAINT `p_fk` FOREIGN KEY (`pid`) REFERENCES `pyp` (`id`),
  CONSTRAINT `u_fk2` FOREIGN KEY (`uid`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_pyp`
--

LOCK TABLES `user_pyp` WRITE;
/*!40000 ALTER TABLE `user_pyp` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_pyp` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-02-26 11:37:31
